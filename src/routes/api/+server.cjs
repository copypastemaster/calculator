...
function POST(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var _b, firstNumber, secondNumber, operator, total;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, request.json()];
                case 1:
                    _b = _c.sent(), firstNumber = _b.firstNumber, secondNumber = _b.secondNumber, operator = _b.operator;
                    ...
                    return [2 /*return*/, (0, kit_1.json)(total)];
            }
        });
    });
}
